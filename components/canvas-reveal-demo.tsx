...
const Card = ({
  ...
  return (
    <div
      ...
      className="border  border-[#42C5E2] group/canvas-card flex items-center justify-center  max-w-sm w-full mx-auto p-4 h-[30rem] relative"
    >
      <Icon className="absolute h-6 w-6 -top-3 -left-3 text-[#42C5E2]" />
      <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-[#42C5E2]" />
      <Icon className="absolute h-6 w-6 -top-3 -right-3 text-[#42C5E2]" />
      <Icon className="absolute h-6 w-6 -bottom-3 -right-3 text-[#42C5E2]" />
