    ...
    <div>
      <footer className="bg-slate-950 mt-12">
        <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          ...
          <div className="mt-16 border-t border-gray-500 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24">
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-[#42C5E2] transition hover:opacity-75"
                >
              ...
              <li>
                <a
                  href="https://dribbble.com/sylusabel"
                  rel="noreferrer"
                  target="_blank"
                  className="text-[#42C5E2] transition hover:opacity-75"
                >
